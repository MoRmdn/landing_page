...
class Responsive {
  ...
  TextScaler textScale(BuildContext context) =>
  ...
  double sBarH(BuildContext context) => mediaQuery(context).padding.top;

  double sBottomPadding(BuildContext context) =>
      mediaQuery(context).padding.bottom;

  final SizedBox sizedBoxH3 = const SizedBox(height: 3);
  ...
  final SizedBox sizedBoxH15 = const SizedBox(height: 15);
  final SizedBox sizedBoxH17 = const SizedBox(height: 17);
  final SizedBox sizedBoxH20 = const SizedBox(height: 20);
  final SizedBox sizedBoxH30 = const SizedBox(height: 30);
  final SizedBox sizedBoxH40 = const SizedBox(height: 40);
  final SizedBox sizedBoxH60 = const SizedBox(height: 60);
  final SizedBox sizedBoxH70 = const SizedBox(height: 70);
  final SizedBox sizedBoxH80 = const SizedBox(height: 80);
  final SizedBox sizedBoxH90 = const SizedBox(height: 90);
  final SizedBox sizedBoxW3 = const SizedBox(width: 3);
  ...
  final SizedBox sizedBoxW20 = const SizedBox(width: 20);
  final SizedBox sizedBoxW30 = const SizedBox(width: 30);
  final SizedBox sizedBoxW40 = const SizedBox(width: 40);
  final SizedBox sizedBoxW50 = const SizedBox(width: 50);
  final SizedBox sizedBoxW80 = const SizedBox(width: 80);
  final SizedBox sizedBoxW100 = const SizedBox(width: 100);
  ...
  final EdgeInsets paddingHorizontal18Vertical24 = const EdgeInsets.symmetric(
    horizontal: 18,
    vertical: 24,
  );
  ...
  EdgeInsets listViewPadding = const EdgeInsets.symmetric(
    vertical: 10,
    horizontal: 15,
  );
}
